...
/*/////////////////////////////////////// Code on KeyPress ////////////////////////////////////////////////*/
	...
	inputKeyRestrict = function(e) {
			...
			//alert("e.which == "+e.which)
			 ...
			 var restrict = ((e.which == 8 || e.which == 9 || e.which == 116 ||e.which == 173 || e.which == 61 || e.which == 37 || e.which == 39 || e.which == 46 || e.which == 187 || e.which == 109 || e.which == 107|| e.which == 189|| e.which == undefined || e.which == 0 ) || (e.which >= 96 && e.which <= 105) ) ? null : String.fromCharCode(e.which).match(/[^0-9]/);
